...
android {
    namespace = "com.spbchurch.radio"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.spbchurch.radio"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
    ...
    buildTypes {
        release {
            ...
            // Use release signing when the keystore env vars are provided,
            // otherwise fall back to the debug key so the APK is still
            // installable for ad-hoc testing.
